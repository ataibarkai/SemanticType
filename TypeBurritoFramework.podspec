#
#  Be sure to run `pod spec lint TypeBurritoFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ataibarkai/TypeBurritoFramework.git", :tag => "v0.3.2" }
